...
const Footer = () => {
    return (
     <div>
    <div class="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6 w-full md:max-w-6xl 
    lg:max-w-6xl mt-10 px-5 md:mx-auto lg:mx-auto md:py-10 lg:py-10 md:mt-20 lg:mt-20 bg-stone-50">
            ...
            <div>
                ...
                <div class="text-sm space-y-2">
                    ...
                    <div class="flex items-center gap-2 pt-4">
                        <input class="border border-gray-500/30 placeholder-gray-500 focus:ring-2 ring-indigo-600 outline-none w-full max-w-64 h-9 rounded px-2" type="email" placeholder="your email" />
    ...
    <div>
        ...
        Copyright 2025 © <a href="https://prebuiltui.com">HotelBookings</a>. All Right Reserved.
    </p>
    </div>
