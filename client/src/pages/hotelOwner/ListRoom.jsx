...
const ListRoom = ()=> {
    ...
    return (
        <div>
            <Title align ='left' title ='Room Listing' subTitle ='View, edit, or manage all listed rooms, Keep the information
            up-to-date to provide the best experience for users.'/>
            
            <p className ='text-gray-500 mt-8'>All Rooms</p>

            <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 md:max-h-200 overflow-y-scroll'>
                    ...
                    <tbody className='text-sm'>
                        {
                            rooms.map((item, index)=>(
                                <tr key={index}>
                                    ...
                                    <td className ='py-3 px-4 text-gray-700 border-t border-gray-300'>
                                        <span className ='text-xs text-gray-400'></span> {item.pricePerNight}
                                    </td>
                                   
                                    <td className ='py-3 px-4 border-t border-gray-300 text-sm test-[#be3e3f] text-center'>
